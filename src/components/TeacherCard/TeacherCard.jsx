      ...
      <div className={css.content}>
        <div className={css.body}>
          ...
          <div className={css.details}>
            <div className={css.line}>
              Speaks: <span className={css.lineSpeaks}>{speaks}</span>
            </div>
        ...
        {open && (
          <div className={css.more}>
            {experience && <p className={css.experience}>{experience}</p>}
                  ...
                  {reviewsArr.slice(0, 3).map((r, i) => (
                    <li key={i} className={css.reviewItem}>
                      {r.avatar ? (
                        ...
                        <div
                          className={css.reviewAvatarFallback}
                          aria-hidden="true"
                        >
                      ...
                      <div className={css.reviewText}>
                        <div className={css.reviewHead}>
                          ...
                          <div className={css.reviewRating}>
                            ...
                            <span>
                              {Number(r.reviewer_rating ?? 0).toFixed(1)}
                            </span>
                          </div>
                        </div>
